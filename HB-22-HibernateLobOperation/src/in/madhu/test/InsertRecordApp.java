...
import in.madhu.model.JobSeeker;
...
public class InsertRecordApp {
	...
	public static void main(String[] args) throws Exception {
		...
		try (FileInputStream fis = new FileInputStream("C:\\Users\\madha\\OneDrive\\Pictures\\comic.png")) {
		...
		try {
			f = new File("C:\\Users\\madha\\OneDrive\\Pictures\\resu.txt");
